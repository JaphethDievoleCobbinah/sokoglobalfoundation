    ...
    return (
        <>
                        ...
                        <div className="col-md-8">
                            <div className="top-bar-left">
                                ...
                                <div className="text">
                                    ...
                                    <a href="tel:+233547148481"><p>+233 547148481</p></a>
                                </div>
                                <div className="text">
                                    <i className="fa fa-envelope"></i>
                                    <a href="mailto:info.sokoglobalfoundation@gmail.com"><p>info.sokoglobalfoundation@gmail.com</p></a>
                                </div>
                            </div>
                        </div>
            ...
            <div className="navbar navbar-expand-lg bg-dark navbar-dark">
                <div className="container-fluid">
                    <Link to="/" className="navbar-brand">SOKO GLOBAL FOUNDATION</Link>
